...
<script>
    $('#guardar').click(function(){
        var error='';
        if ($('#cronograma_f1_aei-grado').val()=='') {
        ...
        if ($('#cronograma_f1_aei-seccion').val()=='') {
        ...
        if ($('#cronograma_f1_aei-nro_estudiantes').val()=='') {
        ...
        if ($('#cronograma_f1_aei-hora_inicio').val()=='') {
        ...
        if ($('#cronograma_f1_aei-hora_fin').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c1_p1').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c1_p2').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c1_p3').val()=='') {
        ...
        /*c2*/
        if ($('#cronograma_f1_aei-c2_p1').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c2_p2').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c2_p3').val()=='') {
        ...
        /*c3*/
        if ($('#cronograma_f1_aei-c3_p1').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c3_p2').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c3_p3').val()=='') {
        ...
        /*c4*/
        if ($('#cronograma_f1_aei-c4_p1').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c4_p2').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c4_p3').val()=='') {
        ...
        /*c5*/
        if ($('#cronograma_f1_aei-c5_p1').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c5_p2').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c5_p3').val()=='') {
        ...
        /*c6*/
        if ($('#cronograma_f1_aei-c6_p1').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c6_p2').val()=='') {
        ...
        if ($('#cronograma_f1_aei-c6_p3').val()=='') {
    ...
    function Grado(event,value,codigo) {
        ...
        $.get( "<?= $secciones ?>?grado="+value+"&codigo_modular="+codigo, function( data ) {$( "#cronograma_f1_aei-seccion" ).html( data );});
        //$( "#w0" ).submit();
    }
</script>