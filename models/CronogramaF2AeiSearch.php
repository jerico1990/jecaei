...
/**
 * CronogramaF2AeiSearch represents the model behind the search form about `app\models\CronogramaF2Aei`.
 */
class CronogramaF2AeiSearch extends CronogramaF2Aei
{
    /**
     * @inheritdoc
     */
